...
function sites(e){for(var t,r,o,i,n=[],s=0;s<e.geometry.coordinates.length;s++)for(var u=e.geometry.coordinates[s].slice(),a=0;a<u.length-1;a++)n.push({x:u[a][0],y:u[a][1]}),n.push({x:(u[a][0]+u[a+1][0])/2,y:(u[a][1]+u[a+1][1])/2}),0==s&&0==a?(t=u[a][0],r=t,o=u[a][1],i=o):(u[a][0]<t&&(t=u[a][0]),u[a][0]>r&&(r=u[a][0]),u[a][0]<o&&(o=u[a][1]),u[a][0]>i&&(i=u[a][1]));return{sites:n,bbox:{xl:t,xr:r,yt:o,yb:i}}}var Voronoi=require("voronoi"),voronoi=new Voronoi,point=require("turf/node_modules/turf-point"),pointOnLine=require("turf/node_modules/turf-point-on-line"),within=require("turf/node_modules/turf-within");module.exports=function(e){for(var t=sites(e),r=voronoi.compute(t.sites,t.bbox),o={type:"FeatureCollection",features:[]},i=0;i<r.vertices.length;i++)o.features.push({type:"Feature",properties:{},geometry:{type:"Point",coordinates:[r.vertices[i].x,r.vertices[i].y]}});for(var n,s={type:"FeatureCollection",features:[e]},u=within(o,s),a={coordinates:[0,0],maxDist:0},p={type:"FeatureCollection",features:[]},f=0;f<e.geometry.coordinates.length;f++)p.features.push({type:"Feature",properties:{},geometry:{type:"LineString",coordinates:e.geometry.coordinates[f]}});for(var c=0;c<u.features.length;c++){for(var d=0;d<p.features.length;d++)n=0==d?pointOnLine(p.features[d],u.features[c]).properties.dist:Math.min(n,pointOnLine(p.features[d],u.features[c]).properties.dist);n>a.maxDist&&(a.coordinates=u.features[c].geometry.coordinates,a.maxDist=n)}return point(a.coordinates)};
