...
var Voronoi=require("voronoi"),voronoi=new Voronoi,point=require("turf-point"),pointOnLine=require("./lib/turf-point-on-line/index.js"),within=require("turf-within"),GeoJSONUtils=require("./utils/GeoJSONUtils.js");module.exports=function(e,t){e=GeoJSONUtils.fixMultiPoly(e);for(var r=GeoJSONUtils.sites(e,t),o=voronoi.compute(r.sites,r.bbox),i={type:"FeatureCollection",features:[]},n=0;n<o.vertices.length;n++)i.features.push({type:"Feature",properties:{},geometry:{type:"Point",coordinates:[o.vertices[n].x,o.vertices[n].y]}});for(var s,a={type:"FeatureCollection",features:[e]},u=within(i,a),p={coordinates:[0,0],maxDist:0},f={type:"FeatureCollection",features:[]},l=0;l<e.geometry.coordinates.length;l++)f.features.push({type:"Feature",properties:{},geometry:{type:"LineString",coordinates:e.geometry.coordinates[l]}});for(var c=0;c<u.features.length;c++){for(var y=0;y<f.features.length;y++)s=0==y?pointOnLine(f.features[y],u.features[c]).properties.dist:Math.min(s,pointOnLine(f.features[y],u.features[c]).properties.dist);s>p.maxDist&&(p.coordinates=u.features[c].geometry.coordinates,p.maxDist=s)}return point(p.coordinates)};
