...
},{"turf-bearing":8,"turf-destination":9,"turf-distance":10,"turf-linestring":14,"turf-point":15}],2:[function(require,module,exports){
var Voronoi=require("voronoi"),voronoi=new Voronoi,point=require("turf-point"),pointOnLine=require("./lib/turf-point-on-line/index.js"),within=require("turf-within"),GeoJSONUtils=require("./utils/GeoJSONUtils.js");module.exports=function(e){e=GeoJSONUtils.fixMultiPoly(e);for(var t=GeoJSONUtils.sites(e),r=voronoi.compute(t.sites,t.bbox),o={type:"FeatureCollection",features:[]},i=0;i<r.vertices.length;i++)o.features.push({type:"Feature",properties:{},geometry:{type:"Point",coordinates:[r.vertices[i].x,r.vertices[i].y]}});for(var n,s={type:"FeatureCollection",features:[e]},a=within(o,s),u={coordinates:[0,0],maxDist:0},p={type:"FeatureCollection",features:[]},f=0;f<e.geometry.coordinates.length;f++)p.features.push({type:"Feature",properties:{},geometry:{type:"LineString",coordinates:e.geometry.coordinates[f]}});for(var l=0;l<a.features.length;l++){for(var c=0;c<p.features.length;c++)n=0==c?pointOnLine(p.features[c],a.features[l]).properties.dist:Math.min(n,pointOnLine(p.features[c],a.features[l]).properties.dist);n>u.maxDist&&(u.coordinates=a.features[l].geometry.coordinates,u.maxDist=n)}return point(u.coordinates)};
},{"./lib/turf-point-on-line/index.js":1,"./utils/GeoJSONUtils.js":21,"turf-point":15,"turf-within":16,"voronoi":19}],3:[function(require,module,exports){
...
},{"geojson-area":3}],8:[function(require,module,exports){
...
},{"turf-point":15}],10:[function(require,module,exports){
...
},{"turf-invariant":13}],11:[function(require,module,exports){
...
},{"turf-featurecollection":11,"turf-inside":12}],17:[function(require,module,exports){
...
},{"./support/isBuffer":17,"_process":6,"inherits":4}],19:[function(require,module,exports){
...
function inspect(e,o){return util.inspect(e,{depth:o||null})}function GeoJSONUtils(){}var area=require("turf-area"),_=require("lodash"),util=require("util");GeoJSONUtils.prototype.fixMultiPoly=function(e){var o=this;if("MultiPolygon"==e.geometry.type&&1==e.geometry.coordinates[0].length)return e.geometry.type="Polygon",e.geometry.coordinates=e.geometry.coordinates[0],e;if("MultiPolygon"==e.geometry.type&&e.geometry.coordinates[0].length>1){var t=_.map(e.geometry.coordinates[0],function(e){return o._toGeoJSONFeature(o._toGeoJSONPolygon(e))}),r=_.map(t,area),n=_.indexOf(r,_.max(r));return console.log(inspect(t)),console.log(area(t[0])),console.log(r),console.log(n),t[n]}return e},GeoJSONUtils.prototype.sites=function(e){for(var o,t,r,n,i=[],l=0;l<e.geometry.coordinates.length;l++)for(var u=e.geometry.coordinates[l].slice(),s=0;s<u.length-1;s++)i.push({x:u[s][0],y:u[s][1]}),i.push({x:(u[s][0]+u[s+1][0])/2,y:(u[s][1]+u[s+1][1])/2}),0==l&&0==s?(o=u[s][0],t=o,r=u[s][1],n=r):(u[s][0]<o&&(o=u[s][0]),u[s][0]>t&&(t=u[s][0]),u[s][1]<r&&(r=u[s][1]),u[s][1]>n&&(n=u[s][1]));return{sites:i,bbox:{xl:o,xr:t,yt:r,yb:n}}},GeoJSONUtils.prototype._toGeoJSONFeature=function(e){return{type:"Feature",geometry:e}},GeoJSONUtils.prototype._toGeoJSONPolygon=function(e){var o={type:"Polygon",coordinates:[e]};return o},module.exports=new GeoJSONUtils;
},{"lodash":5,"turf-area":7,"util":18}]},{},[2])(2)
});