...
function inspect(e,t){return util.inspect(e,{depth:t||null})}function GeoJSONUtils(){}var area=require("turf-area"),_=require("lodash"),util=require("util");GeoJSONUtils.prototype.fixMultiPoly=function(e){var t=this;if("MultiPolygon"==e.geometry.type&&1==e.geometry.coordinates[0].length)return e.geometry.type="Polygon",e.geometry.coordinates=e.geometry.coordinates[0],e;if("MultiPolygon"==e.geometry.type&&e.geometry.coordinates[0].length>1){var o=_.map(e.geometry.coordinates[0],function(e){return t._toGeoJSONFeature(t._toGeoJSONPolygon(e))}),r=_.map(o,area),n=_.indexOf(r,_.max(r));return o[n]}return e},GeoJSONUtils.prototype.sites=function(e){for(var t,o,r,n,i=[],u=0;u<e.geometry.coordinates.length;u++)for(var y=e.geometry.coordinates[u].slice(),l=0;l<y.length-1;l++)i.push({x:y[l][0],y:y[l][1]}),i.push({x:(y[l][0]+y[l+1][0])/2,y:(y[l][1]+y[l+1][1])/2}),0==u&&0==l?(t=y[l][0],o=t,r=y[l][1],n=r):(y[l][0]<t&&(t=y[l][0]),y[l][0]>o&&(o=y[l][0]),y[l][1]<r&&(r=y[l][1]),y[l][1]>n&&(n=y[l][1]));return{sites:i,bbox:{xl:t,xr:o,yt:r,yb:n}}},GeoJSONUtils.prototype._toGeoJSONFeature=function(e){return{type:"Feature",geometry:e}},GeoJSONUtils.prototype._toGeoJSONPolygon=function(e){var t={type:"Polygon",coordinates:[e]};return t},module.exports=new GeoJSONUtils;
